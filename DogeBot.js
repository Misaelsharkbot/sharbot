...
//══════════[ GAME FEATURES ]══════════//
       case 'dare':
              const dare =[
     "come 2 cucharadas de arroz sin guarniciones, si se está arrastrando puedes beber" ,
    ...
    "Dile a la gente al azar _Me acaban de decir que primero era tu gemelo, nos separamos, luego me hice una cirugía plástica. Y esto es lo más ciyuss_" ,
    "menciona el nombre de tu ex" ,
    "¡haz 1 rima para los miembros!" ,
    "envía tu lista de chat de whatsapp" ,
    "Chatea con personas aleatorias con lenguaje gheto y luego ss aquí" ,
    ...
    "cambiar el nombre a *SOY BURRO* durante 24 horas" ,
    ...
    "Hazle una broma a tu ex y di *te amo, por favor regresa* sin decir ¡atrévete!" ,
    "chatea para contactar a wa en el orden de acuerdo a tu % de batería, luego dile *¡tengo suerte de tenerte!*" ,
    "cambiar el nombre a *soy un hijo de randi* durante 5 horas" ,
    ...
    "¡Di *ERES TAN HERMOSO NO MIENTE* a los chicos!" ,
    ...
    "Breakdance durante 30 segundos en la sala de estar 😂" ,
    ...
    "Muestra las últimas cinco personas a las que les enviaste mensajes de texto y lo que decían los mensajes" ,
    ...
    "Envía notas de voz y di, ¿puedo llamarte bebé? Si eres chico, etiqueta a chica/si chica, etiqueta a chico" ,
    "Escriba te amo (nombre de miembro del grupo aleatorio, que está en línea) en el chat personal, (si es niño, escriba el nombre de la niña/si es niña, escriba el nombre del niño), tome una foto de la foto y envíela aquí" .
    ...
    "cambiar el nombre a SOY GAY durante 5 horas" ,
    ...
    "Golpea tu trasero apenas envías el sonido de una bofetada a través de la nota de voz 😂" ,
    "Indique su tipo de novia/novia y envíe la foto aquí con el título, la chica/chico más feo del mundo" ,
    "grita bravooooooooo y envía aquí a través de una nota de voz" ,
    "Toma tu cara y luego envíalo aquí" ,
    "Envía tu foto con un título, soy lesbiana" ,
    "grita usando palabras duras y envíalo aquí a través de vn" ,
    "grita cabrón delante de tu mamá/papá" ,
    "cambiar el nombre a soy idiota por 24 horas" ,
    "Date una bofetada con firmeza y envía el sonido de una bofetada a través de una nota de voz😂" ,
    "Di que amo al dueño del bot xeon a través de una nota de voz" ,
    "Envía tu foto de novia/novio aquí" ,
    ...
    "rompe con tu mejor amigo durante 5 horas sin decirle que es un reto" ,
     ...
     "besa a tu mami o papa y di te amo😌" ,
    ...
    "Si puedes o si quieres, ¿con qué gc/gc externo te harías amigo? (quizás diferente/del mismo tipo)" ,
    ...
    "¿Qué cosa orgullosa obtuviste este año?" , 
    "¿Quién es la persona que puede hacerte increíble?" , 
    "¿Quién es la persona que te ha hecho muy feliz?" , 
    "¿Quién se acerca más a tu tipo ideal de pareja aquí?" , 
    "¿Con quién te gusta jugar?" , 
    "¿Alguna vez has rechazado a la gente? ¿Por qué?" ,
    “Menciona un incidente que te haya dolido y que aún recuerdes” , 
    ...
    "¿Cuándo fue la última vez que hiciste llorar a alguien más? "
    ...
    "¿Qué cosas orgullosas obtuviste este año?" ,
    ...
    "¿Alguna vez has mentido a tus padres?" ,
    "¿Aún te gusta tu ex? "
    "¿Con quién te gusta jugar?" ,
    "¿Alguna vez has robado algo grande en tu vida? ¿Por qué?" ,
    "¿Menciona el indice que te hizo daño que aun no recuerdas" ,
    ...
    "tú no vegetariano o vegetariano" ,
    "Si pudieras ser invisible, ¿qué es lo primero que harías? "
    ...
    "¿Cuál fue tu programa favorito de la infancia?" ,
    "Si pudieras ser un personaje ficticio por un día , ¿a quién elegirías?"
    "¿A quién le envías más mensajes de texto?" ,
    "¿Cuál es la mentira más grande que les has dicho a tus padres? "
    "¿Quién es tu celebridad enamorada?" ,
